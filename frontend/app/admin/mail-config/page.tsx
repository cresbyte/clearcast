      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Configure SMTP server settings and administrative notification
            channels.
          </p>
        </div>
      ...
      <div className="grid gap-6">
        ...
        <Card className="border-none shadow-sm bg-card overflow-hidden">
          <CardHeader className="border-b bg-muted/20">
            ...
            <CardDescription>
              Primary connection details for the mail server.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-none shadow-sm bg-card overflow-hidden">
          <CardHeader className="border-b bg-muted/20">
            ...
            <CardDescription>
              Sender address and administrative alert routing.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
        ...
        <Card className="border-none shadow-sm bg-card overflow-hidden">
          <CardHeader className="border-b bg-muted/20">
            ...
            <CardDescription>
              Encryption and transport layer security protocols.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6 flex flex-wrap gap-12">
            ...
            <div className="flex items-center space-x-4">
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("email_use_ssl", checked)
                }
              />
              <Label
                htmlFor="email_use_ssl"
                className="font-medium cursor-pointer"
              >
                Use SSL (Recommended for 465)
              </Label>
            </div>
          </CardContent>
        </Card>
