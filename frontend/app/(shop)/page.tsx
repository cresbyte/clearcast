...
import flyTying3 from "../assets/salmon.png";
import flyTying2 from "../assets/clearcast-essence.webp";
import flyTying from "../assets/trout.png";
...
const Home = () => {
  ...
  const { data: shopByData, isLoading: shopByLoading } =
    useShopByCatalogSections();
  ...
  const activeHero =
    heroSections.length > 0 ? heroSections[activeHeroIndex] : null;

  const activeShopBySection =
    shopBySections.length > 0 ? shopBySections[0] : null;
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative w-full  min-h-[80vh] sm:min-h-screen flex items-center overflow-hidden bg-[#1a1f1a]">
        <img
          src={
            activeHero?.image ||
            "https://images.unsplash.com/photo-1516934024742-b461fbc4760a?w=2400&auto=format&fit=crop&q=80"
          }
        ...
        <div className="container mx-auto relative z-10 w-full px-8 sm:px-14 lg:px-20 pt-28 sm:pt-36 pb-20">
          <div
            className={cn(
              "max-w-4xl",
              activeHero?.content_alignment === "center" &&
                "mx-auto text-center",
            )}
          >
            ...
            >
              {activeHero?.subtitle ||
                "More than flies — our patterns are built with purpose. Every hackle, every wrap, every material chosen with one goal: to catch more fish."}
            </p>
            ...
            >
              <Link href={activeHero?.button_link || "/fly-bars"}>
                <Button
                  className="h-[46px] px-7 text-[10px] font-black uppercase tracking-[0.22em] rounded-sm
            ...
            {heroSections.map((_: any, idx: number) => (
              <button
                ...
                className={cn(
                  ...
                  activeHeroIndex === idx
                    ? "h-7 bg-secondary"
                    : "h-4 bg-white/30 hover:bg-white/55",
                )}
              />
            ))}
          </div>
            ...
            {[
              ...
              <div
                ...
                className={cn(
                  "space-y-2",
                  i === 0
                    ? "sm:pr-10 py-6 sm:py-0"
                    : i === 1
                      ? "sm:px-10 py-6 sm:py-0"
                      : "sm:pl-10 py-6 sm:py-0",
                )}
              >
        ...
        <div className="container mx-auto px-8 sm:px-14 lg:px-20">
          <div className="text-center mb-10">
            ...
            <p className="text-[12px] sm:text-[13px] text-muted-foreground max-w-sm mx-auto leading-relaxed">
              Handpicked by our tiers — the flies that are catching fish right
              now.
            </p>
          </div>
          ...
          <div className="container mx-auto px-8 sm:px-14 lg:px-20">
            <div className="mb-7">
              ...
              <p className="text-[12px] sm:text-[13px] text-muted-foreground leading-relaxed max-w-xl">
                {activeShopBySection.subtitle ||
                  "Browse our top collections, curated for every angler and every water."}{" "}
                <Link
                  href="/fly-bars"
                ...
                : displayedShopByFilters.map((filter: any) => (
                    <div
                      ...
                      onClick={() => {
                        router.push(
                          filter.slug
                            ? `/fly-bars?filter=${encodeURIComponent(filter.slug)}`
                            : "/fly-bars",
                        );
                      }}
                    >
                      <div className="aspect-[4/3] overflow-hidden bg-[#ECEAE4]">
                        {filter.image ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <span className="text-[12px] font-serif text-muted-foreground/60">
                              {filter.name}
                            </span>
                          </div>
                        )}
                      ...
                      <p
                        className="mt-2.5 text-[11px] font-bold uppercase tracking-[0.12em] text-foreground
      ...
      {contentSections.length > 0 ? (
        contentSections.map((section: any, index: number) => {
          if (
            ...
            section.featured_filter_details
          ) {
            return (
          ...
          const isBespokeBench =
            section.title?.toLowerCase() === "the bespoke bench";

          if (!section.image || isBespokeBench) {
            return (
              <section
                key={section.id || index}
                className="py-16 sm:py-24 bg-[#C4D4CE]"
              >
                <div className="container mx-auto px-8 sm:px-14 lg:px-20 text-center max-w-xl">
                  ...
                  {section.button_text && (
                    <Link href={section.button_link || "/fly-bars"}>
                      <Button
                        className="h-[44px] px-8 text-[10px] font-black uppercase tracking-[0.22em] rounded-sm
          ...
          if (index % 3 === 2) {
            return (
              <section
                key={section.id || index}
                className="bg-[#1C2B35] py-16 sm:py-20"
              >
                <div className="container mx-auto px-8 sm:px-14 lg:px-20">
                  <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                    <div className="w-full md:w-1/2 space-y-5 order-2 md:order-1">
                      ...
                      {section.subtitle && (
                        <p className="text-[13px] italic font-serif text-white/55 leading-relaxed">
                          {section.subtitle}
                        </p>
                      )}
                      ...
                      {section.button_text && (
                        <Link href={section.button_link || "/fly-bars"}>
                          <Button
                            className="h-[44px] px-7 text-[10px] font-black uppercase tracking-[0.22em] rounded-sm
              ...
              <div className="container mx-auto px-8 sm:px-14 lg:px-20">
                ...
                >
                  ...
                  <div className="w-full md:w-[45%] space-y-5">
                    ...
                    {section.subtitle && (
                      <p className="text-[13px] italic font-serif text-muted-foreground leading-relaxed">
                        {section.subtitle}
                      </p>
                    )}
        ...
        <>
          ...
          <section className="py-16 sm:py-24 bg-[#C4D4CE]">
            <div className="container mx-auto px-8 sm:px-14 lg:px-20 text-center max-w-xl">
              ...
              <p className="text-[13px] text-foreground/65 leading-relaxed mb-8">
                Can't find the fly you are looking for? Our tiers work directly
                with you to create custom patterns matched exactly to your local
                hatch, your rod, and your river.
              </p>
              <Link href="/contact">
                <Button
                  className="h-[44px] px-8 text-[10px] font-black uppercase tracking-[0.22em] rounded-sm
            ...
            <div className="container mx-auto px-8 sm:px-14 lg:px-20">
              <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                <div className="w-full md:w-1/2 space-y-5 order-2 md:order-1">
                  ...
                  <p className="text-[13px] text-white/65 leading-relaxed">
                    Not sure where to start? Our curated fly sets take the
                    guesswork out of fly selection — each matched to a specific
                    scenario: spring creek, stillwater, streamer fishing, and
                    more.
                  </p>
                  <Link href="/fly-bars">
                    <Button
            ...
            {[
              {
                ...
                excerpt:
                  "Tungsten beads sink faster and fish deeper — here's why they've become a staple on our bench and why ribbing changes everything.",
              },
              {
                img: flyTying2,
                title: "Matching the Hatch: A Clearcast Guide",
                excerpt:
                  "Understanding what your local fish are feeding on is the difference between a blank day and a memorable one.",
              },
              {
                img: flyTying3,
                title: "Caring for Your Clearcast Collection",
                excerpt:
                  "Flies last longer when cared for properly. Dry them, store them right, and they'll fish perfectly season after season.",
              },
            ].map((post) => (
              <div key={post.title} className="group cursor-pointer">
                ...
                <h3
                  className="text-[13px] font-bold text-foreground mb-2 leading-snug
                               group-hover:text-secondary transition-colors duration-200"
                >
                  {post.title}
                </h3>
