...
export const metadata = {
  title: "Frequently Asked Questions | ClearCast Fly ",
  description:
    "Find answers to common questions about our fly patterns, shipping, and return policies.",
};
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We know you have a trip coming up. In-stock flies from the Fly Bar typically ship within 72 hours via tracked mail. For Custom Orders, our lead times scale proportionally with the size and complexity of your request. Since premium bench-work cannot be rushed, we will provide you with a tailored timeline for your specific order to guarantee that every wrap is perfect before they leave the vice.",
  },
  {
    question: "I’m not sure what to buy for my local river. Can you help?",
    answer:
      "Absolutely. If you’re staring at a hatch you don't recognize, shoot us a message on WhatsApp or email with a photo of the bug or your general location. We’ll help you 'Match the Hatch' with a selection from our current inventory so you aren't wasting casts.",
  },
  {
    question: "How many takes will these flies survive?",
    answer:
      "Our flies aren't 'one-and-done.' We double-whip finish and use reinforced threading on all our nymphs and streamers. To maximize the life of your dries, we recommend using a high-quality desiccant shake and avoiding forceps on the hackle. Built to be fished, not just admired.",
  },
];
