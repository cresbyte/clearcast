...
export const metadata = {
  title: "Privacy Policy | ClearCast Fly ",
  description:
    "Learn how ClearCast Fly collects, uses, and protects your personal information.",
};
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground/80 leading-relaxed space-y-12">
          <section className="space-y-4">
            <p>
              ClearCast Fly operates this store and website, including all
              related information, content, features, tools, products and
              services, in order to provide you, the customer, with a curated
              shopping experience (the "Services"). ClearCast Fly is powered by
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              <p>
                ...
                such as recommending products related to your purchases.
              </p>
              <p>
          ...
          <section className="space-y-6">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                disclosure of certain information to third parties.
              </li>
              <li>
          ...
          <section className="space-y-6">
            ...
            <p>
              ...
              with our Store, along with other merchants and with Shopify.
            </p>
          </section>
          ...
          <section className="space-y-6 bg-[#F9F9F7] p-8 border border-border/50 not-prose">
            <h2 className="text-2xl font-serif font-bold text-foreground tracking-tight mb-4">
              Contact Us
            </h2>
