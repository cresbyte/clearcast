...
export const metadata = {
  title: "Terms of Service | ClearCast Fly ",
  description:
    "The terms and conditions for using ClearCast Fly services and products.",
};
    ...
    <div className="min-h-screen bg-white py-24 md:py-32">
      <div className="container mx-auto px-4 max-w-4xl">
        <header className="mb-16 text-center">
          <span className="text-[10px] uppercase tracking-[0.3em] font-black text-primary/60">
            Legal
          </span>
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground/80 leading-relaxed space-y-12">
          <section className="space-y-4">
            ...
            <p>
              Welcome to ClearCast Fly ! The terms “we”, “us” and “our” refer to
              ClearCast Fly . ClearCast Fly operates this store and website,
              including all related information, content, features, tools,
              products and services in order to provide you, the customer, with
              a curated shopping experience (the “Services”). ClearCast Fly is
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              ClearCast Fly reserves the right to accept or decline your order
              for any reason at its discretion. Your order is not accepted until
              ClearCast Fly confirms acceptance. We must receive and process
              your payment before your order is accepted. Please review your
              order carefully before submitting, as ClearCast Fly may be unable
              to accommodate cancellation requests after an order is accepted.
              In the event that we do not accept, make a change to, or cancel an
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              owned by ClearCast Fly , its affiliates or licensors and are
            ...
            <p>
              ...
              property of ClearCast Fly , Shopify or any third party.
              Unauthorized use of the Services may be a violation of federal and
              state intellectual property laws. All rights not expressly granted
              herein are reserved by ClearCast Fly .
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ClearCast Fly is powered by Shopify, which enables us to provide
              the Services to you. However, any sales and purchases you make in
              our Store are made directly with ClearCast Fly . By using the
              Services, you acknowledge and agree that Shopify is not
              responsible for any aspect of any sales between you and Clearcast
              Fly , including any injury, damage, or loss resulting from
              purchased products and services. You hereby expressly release
              Shopify and its affiliates from all claims, damages, and
              liabilities arising from or related to your purchases and
              transactions with ClearCast Fly .
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              Privacy Policy. By using the Services, you acknowledge that you
              have read these privacy policies.
            </p>
            <p>
              ...
              for more details on how we, Shopify, and our partners use your
          ...
          <section className="space-y-4">
            ...
            <p>
              EXCEPT AS EXPRESSLY STATED BY ClearCast Fly , THE SERVICES AND ALL
              PRODUCTS OFFERED THROUGH THE SERVICES ARE PROVIDED 'AS IS' AND 'AS
          ...
          <section className="space-y-4">
            ...
            <p>
              TO THE FULLEST EXTENT PROVIDED BY LAW, IN NO CASE SHALL Clearcast
              Fly , OUR PARTNERS, DIRECTORS, OFFICERS, EMPLOYEES, AFFILIATES,
              AGENTS, CONTRACTORS, SERVICE PROVIDERS OR LICENSORS BE LIABLE FOR
          ...
          <section className="space-y-6 bg-[#F9F9F7] p-8 border border-border/50 not-prose">
            ...
            <p className="text-sm text-muted-foreground/80 leading-relaxed">
              ...
              <a
                href="mailto:lila@clearcastfly.com"
                className="text-primary font-bold hover:underline"
              >
        ...
        <footer className="mt-24 pt-12 border-t border-border text-center">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} ClearCast Fly . All rights
            reserved.
          </p>
        </footer>
      </div>
