        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <p className="text-[13px] text-white/60 leading-relaxed max-w-xs italic font-serif">
              Premium fly-tying patterns and high-caliber gear for serious
              anglers. Born on the water, built for the hatch.
            </p>
            <div className="flex space-x-5 pt-2">
              <a
                href="#"
                className="text-white/40 hover:text-secondary transition-all duration-300"
              >
          ...
          <div className="lg:pl-8">
            <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-white/40 mb-10">
              The Collection
            </h4>
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-[13px] text-white/60 leading-relaxed">
                If you are seeking something, not in our inventory, let us know!
                We can talk about ordering any pattern of your choice - just{" "}
                <a
                  href="mailto:lila@clearcastfly.com"
                  className="text-secondary hover:underline transition-colors font-bold"
                >
                  send an email
                </a>
                .
